...
vim.opt.smartindent = false -- disable smart indent as it messes with elixir comments (#) too much, apparently because the editor thinks we're writing a C preprocessor cmd like #define
